    ...
    const onScan = (data)=>{
      (async ()=>{
        try{
          ...
          await play(id);
          // Close scanner overlay once we successfully started playback
          stopQRScanner();

          // Bring player into view and clear overlay toast
          setCamToast("");
          ...
          setCamToast(msg);
          status(msg);
          // Continue scanning so the user can try again quickly
